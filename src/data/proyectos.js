...
export const PROYECTOS = [
  {id:"habitacional", icon:"🏠", label:"Habitacional", desc:"Casa o departamento de uso familiar, hasta 450 m². Acabados funcionales y de buena calidad.", base_m2:10500},
  {id:"residencial",  icon:"🏡", label:"Residencial",  desc:"Casa de gran escala (400 m² en adelante) con espacios generosos y áreas de servicio.",      base_m2:12000},
...
export const STEPS = [
  ...
  {id:"puertas",     title:"Puertas interiores",           sub:"¿Qué tipo de puerta?"},
  {id:"closets",     title:"Closets y carpintería fija",   sub:"¿Qué nivel de carpintería interior?"},
  {id:"vanos",       title:"Apertura de ventanas",         sub:"¿Qué tanta luz y conexión con el exterior?"},
  {id:"canceleria",  title:"Sistema de cancelería",        sub:"¿Qué calidad de marcos y vidrio?"},
